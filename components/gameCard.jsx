...
export default function GameCard({gameName, rating, thumbnail}){
    ...
    return (
        <div className="bg-slate-400 m-5 w-[12.5rem] h-[20rem] rounded-md flex flex-col items-center content-center shadow-black shadow-lg relative hover:scale-105 hover:transition-transform hover:duration-300">
                <img className="select-none pointer-events-none w-full h-full flex-3 object-cover rounded-t-md" src={imageUrl}/>            
            ...
            <div className= "flex-1 text-white w-full ">
                <div className="overflow-hidden whitespace-nowrap text-ellipsis">{gameName}</div>
